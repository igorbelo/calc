...
func NewInnerExprContext(parser antlr.Parser, ctx antlr.ParserRuleContext) *InnerExprContext {
...
func (s *InnerExprContext) Expression() IExpressionContext {
	var t = s.GetTypedRuleContext(reflect.TypeOf((*IExpressionContext)(nil)).Elem(), 0)
...
func (p *CalcParser) expression(_p int) (localctx IExpressionContext) {
	...
	case CalcParserT__0:
		localctx = NewInnerExprContext(p, localctx)
		p.SetParserRuleContext(localctx)
		_prevctx = localctx
		{
			p.SetState(9)
